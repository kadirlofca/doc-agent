...
import { Loader2Icon, MonitorIcon, ServerIcon, FileTextIcon } from "lucide-react";
...
export function CollectionCards({ onSelectCollection }: CollectionCardsProps) {
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {collections.map((coll) => (
          <button
            ...
            className="group flex flex-col items-start gap-3 rounded-xl border bg-card p-6 text-left transition-all hover:border-primary/50 hover:shadow-md"
          >
